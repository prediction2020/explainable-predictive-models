...
class model:
	def __init__(self,name,dataset,fixed_params,tuning_params=None):
		self.name = name
	...
	def load_model(self, path_to_model):
		if self.name =='MLP':
			self.best_model = load_model(path_to_model)
		else:
		  	self.best_model = pickle.load(open(path_to_model,'rb'))
	...
	def save_model(self,path_to_model):
		if self.name =='MLP':
			self.best_model.save(path_to_model)
		else:
			pickle.dump(self.best_model, open(path_to_model,'wb'))
